...
{
    private ShapeableImageView mContentImageView;
    ...
    public NgvChildImageView(Context context,int cornerSize)
    {
        super(context, null);
        initChildView(context,cornerSize);
    }
    ...
    private void initChildView(Context context, int corner)
    {
        mContentImageView = new ShapeableImageView(context);
        // 圆角半径
        mContentImageView.setShapeAppearanceModel(
