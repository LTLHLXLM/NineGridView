...
public class NineGridView extends ViewGroup implements AbsNgvAdapter.OnDataChangedListener
{
    ...
    public NineGridView(Context context, AttributeSet attrs)
    {
        ...
        mAttrOptions.setImageCornerSize(ta.getDimensionPixelSize(R.styleable.NineGridView_imageCorner, context.getResources().getDimensionPixelOffset(R.dimen.image_corner_size)));
    }
    ...
    public void setImageCornerSize(int cornerSize)
    {
        //dp转px
        cornerSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, cornerSize, getResources().getDisplayMetrics());
        mAttrOptions.setImageCornerSize(cornerSize);
        requestLayout();
    }
    ...
    {
        View childViewGroup = mAdapter.createContentView(getContext(),mAttrOptions.getImageCornerSize());
